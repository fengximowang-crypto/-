      ...
      <div style={{ display: 'flex', gap: 10, marginBottom: 20, flexWrap: 'wrap', alignItems: 'center' }}>
        ...
        <div style={{ position: 'relative', flex: 1, minWidth: 160 }}>
          ...
          <input
            ...
            placeholder="搜索姓名或号码..."
            style={{ background: '#1a1a1a', border: '1px solid #333', color: '#f0f0f0', borderRadius: 8, padding: '8px 10px 8px 32px', fontSize: 13, width: '100%', outline: 'none' }}
          />
        </div>
        ...
        <select
          ...
          style={{ background: '#1a1a1a', border: '1px solid #333', color: '#888', borderRadius: 8, padding: '7px 10px', fontSize: 12, outline: 'none' }}
        >
        ...
        <select
          ...
          style={{ background: '#1a1a1a', border: '1px solid #333', color: '#888', borderRadius: 8, padding: '7px 10px', fontSize: 12, outline: 'none' }}
        >
          <option value="overall">按总评排序</option>
          <option value="name">按姓名排序</option>
          <option value="number">按号码排序</option>
        </select>
      </div>
